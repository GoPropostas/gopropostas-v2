...
<style>
    ...
    .plano-hero {
        background: linear-gradient(135deg, #062B36 0%, #0C6D84 100%);
        border-radius: 28px;
        padding: 34px 30px;
        color: white;
...
def tela_plano_pagamento(usuario_id: str, usuario_email: str):
    ...
    <div class="plano-hero">
        ...
        <div class="plano-badge">Plano único: R$ 15,00 / mês</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="plano-card">
            ...
            <div class="plano-mini">
                Gere o QR Code e pague em poucos segundos.
            </div>
        </div>
        """, unsafe_allow_html=True)
            ...
            with st.spinner("Gerando PIX..."):
                try:
                    ...
                    if not qr_base64 and data.get("raw"):
                        try:
                            qr_base64 = data["raw"]["point_of_interaction"]["transaction_data"]["qr_code_base64"]
                            qr_text = data["raw"]["point_of_interaction"]["transaction_data"]["qr_code"]
                        except Exception:
                            pass
    ...
    with col2:
        ...
        <div class="plano-card">
            ...
            <div class="plano-mini">
                Melhor opção para quem quer manter o acesso sempre ativo.
            </div>
        </div>
        """, unsafe_allow_html=True)
...
def tela_sistema_liberado():
    ...
    st.info("Aqui você encaixa o restante do seu sistema.")
    st.markdown('</div>', unsafe_allow_html=True)
